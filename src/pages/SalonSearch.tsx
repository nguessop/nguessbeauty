...
const SalonSearch: React.FC = () => {
  ...
  usePageTitle('pages.salons.title');
  ...
  const getPriceRangeText = (range: string) => {
    switch (range) {
      case 'budget': return t('search.priceRange.budget');
      case 'mid': return t('search.priceRange.mid');
      case 'premium': return t('search.priceRange.premium');
      default: return '';
    }
  };
  ...
  return (
    <WatermarkBackground watermarkText="NGUESSBEAUTY SALONS">
      <div className="min-h-screen bg-gray-50">
        {/* Header */}
        <div className="bg-white shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <h1 className="text-3xl font-bold text-secondary-900 mb-6">
              {t('pages.salons.title')}
            </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    >
                      ...
                      <option value="budget">{t('search.priceRange.budget')}</option>
                      <option value="mid">{t('search.priceRange.mid')}</option>
                      <option value="premium">{t('search.priceRange.premium')}</option>
                    </select>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex justify-between items-center mb-6">
            <p className="text-gray-600">
              {t('search.results', { count: filteredSalons.length })}
            </p>
          </div>
            ...
            {filteredSalons.map((salon, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <div className="mb-4">
                    ...
                    <div className="flex items-center space-x-4 text-sm text-secondary-600">
                      <div className="flex items-center space-x-1">
                        ...
                        <span>({salon.reviewCount} {t('search.reviews')})</span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {salon.services.length > 3 && (
                        <span className="px-2 py-1 bg-gray-100 text-gray-600 text-xs rounded-full">
                          +{salon.services.length - 3} {t('search.others')}
                        </span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    <div className="text-sm text-secondary-600">{t('search.startingFrom')}</div>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <div className="flex items-center space-x-2 text-sm">
                      ...
                      <span className="text-secondary-600">
                        {t('search.openToday')}: 08:00 - 18:00
                      </span>
                    </div>
                  </div>
                </div>

...
const Notifications: React.FC = () => {
  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      message: t('notifications.messages.appointmentTomorrow'),
    ...
    },
    {
      ...
      message: t('notifications.messages.appointmentConfirmed'),
    ...
    },
    {
      ...
      message: t('notifications.messages.weekendOffer'),
    ...
    },
    {
      id: '4',
      type: 'review-request',
      title: t('notifications.reviewRequest'),
      message: t('notifications.messages.reviewRequest'),
  ...
  const filters = [
    ...
    { id: 'read', label: t('notifications.filters.read'), count: notifications.length - unreadCount }
  ];

  return (
    <WatermarkBackground watermarkText="NGUESSBEAUTY NOTIFICATIONS">
              ...
              {filteredNotifications.length > 0 ? (
                ...
                <div className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">
                    {filter === 'unread' ? t('notifications.noUnread') : 
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-semibold text-secondary-900">{t('notifications.settings.appointmentReminders')}</h3>
                  <p className="text-sm text-secondary-600">{t('notifications.settings.appointmentRemindersDesc')}</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-semibold text-secondary-900">{t('notifications.settings.whatsapp')}</h3>
                  <p className="text-sm text-secondary-600">{t('notifications.settings.whatsappDesc')}</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" className="sr-only peer" defaultChecked />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-semibold text-secondary-900">{t('notifications.settings.sms')}</h3>
                  <p className="text-sm text-secondary-600">{t('notifications.settings.smsDesc')}</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" className="sr-only peer" defaultChecked />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-semibold text-secondary-900">{t('notifications.settings.promotions')}</h3>
                  <p className="text-sm text-secondary-600">{t('notifications.settings.promotionsDesc')}</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-semibold text-secondary-900">{t('notifications.settings.reviews')}</h3>
                  <p className="text-sm text-secondary-600">{t('notifications.settings.reviewsDesc')}</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" className="sr-only peer" defaultChecked />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
